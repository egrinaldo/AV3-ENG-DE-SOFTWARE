  ...
  return (
    <>
      ...
      >
        ...
        <option value="Boa Vista de São Caetano">
        ...
        <option value="Cajazeiras VI">Cajazeiras VI</option>
        <option value="Cajazeiras VII">Cajazeiras VII</option>
        <option value="Cajazeiras VIII">Cajazeiras VIII</option>
        ...
        <option value="Centro Administrativo da Bahia">
        ...
        <option value="Engenho Velho da Federação">
        ...
        <option value="Fazenda Grande do Retiro">
        ...
        <option value="Granjas Rurais Presidente Vargas">
          Granjas Rurais Presidente Vargas
        </option>
        <option value="IAPI">IAPI</option>
        <option value="Ilha de Bom Jesus dos Passos">
